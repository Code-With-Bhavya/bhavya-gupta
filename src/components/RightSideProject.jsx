    ...
    return (
        <div className='relative flex justify-center items-center '>
            ...
            <motion.div
                ...
                className="relative w-[50rem] h-[50rem]">  
                {/* Circular Gradients */}
            ...
            <motion.div
                ...
                transition={{ delay: 0.1, ease: 'easeInOut', duration: 0.5 }}
                className="relative w-[574px] h-[310px]"> 
                ...
                <div className="absolute top-1/2 -translate-y-1/2 right-2  z-10 " >
                    <GlowCard opacity={0.5} innercolor='#FD6F00' color='#fffff' secondcolor='#fffff' className='relative'>
                        <div className="p-[21px] w-[574px]  backdrop-blur-[40px] rounded-[14px] bg-[url('/card2.png')] bg-no-repeat bg-center bg-cover">
                            {project.description}
                        </div>
                    </GlowCard>
                </div>
                ...
                {/* Tags*/}
                <div className="absolute bottom-2 right-10 flex gap-4 z-0">
