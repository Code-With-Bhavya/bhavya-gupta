...
const Footer = () => {
    ...
    return (
        <div className='pointer-events-auto h-[50px]'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
                <h1 className='font-semibold text-[1.3em] text-[#fff] hover:scale-105 pointer-events-auto transition-all ease-linear delay-50'>
